...
const cityContent = {
  Jakarta: {
    description:
      "Jakarta, ibu kota Indonesia, menawarkan perpaduan unik antara modernitas dan warisan budaya. Nikmati wisata sejarah di Kota Tua, kuliner legendaris, hingga kehidupan malam yang dinamis.",
    gallery: [
  ...
  Bandung: {
    description:
      "Bandung dikenal sebagai Kota Kembang dengan udara sejuk, factory outlet, dan wisata alam yang memukau. Jelajahi keindahan alam pegunungan dan kuliner khas Sunda.",
    gallery: [
  ...
  Yogyakarta: {
    description:
      "Jantung budaya Jawa dengan kekayaan sejarah dan tradisi. Jelajahi Candi Borobudur, keraton, dan seni jalanan yang hidup.",
    gallery: [
  ...
  Semarang: {
    description:
      "Kota dengan jejak sejarah kolonial yang kuat dan kuliner ikonis seperti lumpia. Temukan keindahan Lawang Sewu dan Kota Lama.",
    gallery: [
  ...
  Surabaya: {
    description:
      "Kota Pahlawan dengan semangat modern dan sejarah perjuangan. Nikmati wisata kuliner khas Surabaya dan taman kota yang hijau.",
    gallery: [
  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen">
        {/* Hero Section */}
        <section
          className="relative h-[450px] bg-cover bg-center text-white flex items-center justify-start"
          style={{
            backgroundImage:
        ...
        <section className="px-6 py-8 bg-gray-50 ">
          <h2 className="text-2xl font-semibold mb-6 text-gray-400 text-center">
            Pilih Kota
          </h2>
            ...
            >
              {cities.map((city) => (
                <SwiperSlide
                  ...
                  className="!w-[280px] cursor-pointer group relative"
                >
                ...
                <div className="p-5">
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10.293 3.293a1 1 0 011.414 0l5.293 5.293a1 1 0 010 1.414l-5.293 5.293a1 1 0 01-1.414-1.414L13.586 10H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 010-1.414z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </Link>
